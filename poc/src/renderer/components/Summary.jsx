...
const Summary = ({ 
  ...
  const addBulletPoint = (section, setter) => {
    setter([...section, '']);
  };
  
  // Function to update a specific bullet point
  const updateBulletPoint = (section, index, value, setter) => {
  ...
  const removeBulletPoint = (section, index, setter) => {
    const updatedSection = [...section];
  ...
  const renderList = (items, updateFn, removeFn, addFn) => {
